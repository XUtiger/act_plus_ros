...
DATA_DIR = '/home/easy/yin/robot_arm/opensource_prj/act_plus_ros/src/act_arm/data'
SIM_TASK_CONFIGS = {
    ...
    'sim_transfer_cube_human_training':{
        'dataset_dir': DATA_DIR + '/transfer_cube_human_training',
        'num_episodes': 50,
        'episode_len': 400,
        'camera_names': ['top']
    },
